USE [master]
GO
/****** Object:  Database [Estuda_Sql]    Script Date: 17/10/2023 15:25:15 ******/
...
USE [Estuda_Sql]
GO
/****** Object:  UserDefinedFunction [dbo].[IMC_FN_CALCULA_IMC]    Script Date: 17/10/2023 15:25:15 ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dbo].[IMC_FN_CLASSIFICACAO]    Script Date: 17/10/2023 15:25:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END  
GO
/****** Object:  UserDefinedFunction [dbo].[IMC_FN_VALIDACPF]    Script Date: 17/10/2023 15:25:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  Table [dbo].[IMC_LOG_DELETADO]    Script Date: 17/10/2023 15:25:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[IMC_TB_INFO_USER]    Script Date: 17/10/2023 15:25:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[IMC_TB_RESULTADO]    Script Date: 17/10/2023 15:25:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[IMC_TB_USER]    Script Date: 17/10/2023 15:25:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[IMC_SP_ALTERAR_PESO_ALTURA]    Script Date: 17/10/2023 15:25:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE PROCEDURE [dbo].[IMC_SP_ALTERAR_PESO_ALTURA] --[IMC_SP_ALTERAR_PESO_ALTURA] '49747128888', 100, 1.80
...
BEGIN
	...
	DECLARE @CPF_VALIDA VARCHAR(11) = (SELECT CPF FROM IMC_TB_INFO_USER WHERE CPF = @CPF)
	...
	BEGIN
		...
		SET @RETORNO = 'CPF ALTERADO COM SUCESSO'
		
	END
	ELSE
	BEGIN
		SET @RETORNO = 'ERRO AO ALTERAR CPF'
...
GO
/****** Object:  StoredProcedure [dbo].[IMC_SP_ALTERAR_SENHA]    Script Date: 17/10/2023 15:25:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
    ...
    BEGIN
        ...
        ELSE
        BEGIN
            SELECT 'Nova senha não atende aos requisitos mínimos'
        END
    END
    ELSE
    BEGIN
...
END
GO
/****** Object:  StoredProcedure [dbo].[IMC_SP_CONSULTA_USUARIO]    Script Date: 17/10/2023 15:25:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[IMC_SP_CRIACAO_USUARIO]    Script Date: 17/10/2023 15:25:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[IMC_SP_DELETAR_USUARIO]    Script Date: 17/10/2023 15:25:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[IMC_SP_DELETAR_USUARIO] --[IMC_SP_DELETAR_USUARIO]  
	@ID INT  
  AS
BEGIN
...
GO
/****** Object:  StoredProcedure [dbo].[IMC_SP_RESULTADO]    Script Date: 17/10/2023 15:25:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[IMC_SP_RESULTADO] --[IMC_SP_RESULTADO] NULL, NULL, 3, NULL
...
BEGIN
	...
	INSERT INTO IMC_TB_RESULTADO (
			...
			, GETDATE()
			, 1
			, (SELECT DBO.PDA_FN_CLASSIFICACAO_IMC(@IMC))
			)
END

...
namespace Application.Controllers
{
    ...
    {
        private readonly IAlterarSenhaService service;
        private readonly IMapper mapper;
        private readonly string chaveToken;

        public AlterarSenhaController(IConfiguration configuration, IAlterarSenhaService service, IMapper mapper)
        {
        ...
        //// PATCH api/todo
        ///// <summary>
        ///// Retorna uma lista de AlterarSenha
        ///// </summary>
        //[HttpPatch]
        //public async Task<IActionResult> Select(Domain.DTO.AlterarSenha entityIn)
        //{
        //    var autenticacao = Utils.ValidaToken(User.Claims, this.chaveToken);
        //    if (autenticacao == null)
        //        return Unauthorized();

        //    var entity = mapper.Map<AlterarSenha>(entityIn);
        ...
        //// POST api/todo
        ///// <summary>
        ///// Cria um(a) novo(a) AlterarSenha
        ///// </summary>
        //[HttpPost]
        //public async Task<IActionResult> Create(Domain.DTO.AlterarSenha entityIn)
        //{
        //    var autenticacao = Utils.ValidaToken(User.Claims, this.chaveToken);
        //    if (autenticacao == null)
        //        return Unauthorized();
        ...
        //// PUT api/todo
        ///// <summary>
        ///// Altera um(a) novo(a) AlterarSenha
        ///// </summary>
        //[HttpPut]
        //public async Task<IActionResult> Update(Domain.DTO.AlterarSenha entityIn)
        //{
        //    var autenticacao = Utils.ValidaToken(User.Claims, this.chaveToken);
        //    if (autenticacao == null)
        //        return Unauthorized();
